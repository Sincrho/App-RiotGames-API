<script >  
    ...
    onMount(async function() {
          ...
          dataTorneo = await response.json();
          //console.log(data)
      });
    ...
    $: sort = (column) => {
        ...
        dataTorneo = dataTorneo.sort(sort);
    }
</script>
  ...
  <div class="container" style="padding-top:7%">  
    <table class="highlight centered">
      <thead class="blue darken-1 white-text">
        <tr>
          <th on:click={sort("nombre_torneo")}>Torneo</th>
          <th></th>
        </tr>
      </thead>
      <tbody style = "background: rgba(0,0,0,0.5);">
        {#each dataTorneo as row}
          <tr>
    ...
    <a href="/#/NuevoTorneo" class="btn-floating btn-large waves-effect waves- blue darken-1"><i class="material-icons left">add</i></a>
  </div>  
</body>
