    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$c, 82, 15, 2258);
    			attr_dev(div, "class", "container col s4");
    			add_location(div, file$c, 81, 13, 2210);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$c, 96, 16, 2618);
    			attr_dev(div, "class", "col s4");
    			add_location(div, file$c, 95, 14, 2580);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    ...
    function create_each_block$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "align", "center");
    			attr_dev(span, "class", "centered flow-text");
    			add_location(span, file$c, 107, 18, 2975);
    			attr_dev(div, "class", "col s4");
    			add_location(div, file$c, 106, 16, 2936);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$c, 71, 9, 1978);
    			attr_dev(div0, "class", "card-content ");
    			set_style(div0, "background", "rgba(0,0,0,0.5)");
    			add_location(div0, file$c, 70, 8, 1901);
    			attr_dev(div1, "class", "col s2");
    			add_location(div1, file$c, 76, 10, 2108);
    			attr_dev(div2, "class", "row");
    			set_style(div2, "background", "rgba(0,0,0,0.5)");
    			add_location(div2, file$c, 75, 8, 2037);
    			attr_dev(div3, "class", "col s3");
    			add_location(div3, file$c, 90, 12, 2472);
    			attr_dev(div4, "class", "row ");
    			add_location(div4, file$c, 89, 10, 2439);
    			attr_dev(div5, "class", "col s3");
    			add_location(div5, file$c, 102, 12, 2824);
    			attr_dev(div6, "class", "row ");
    			add_location(div6, file$c, 101, 10, 2792);
    			set_style(div7, "background", "rgba(0,0,0,0.5)");
    			attr_dev(div7, "class", "card-content");
    			add_location(div7, file$c, 88, 8, 2362);
    ...
    function create_each_block$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			attr_dev(td0, "class", "blue-text");
    			add_location(td0, file$d, 40, 14, 1448);
    			attr_dev(a0, "href", a0_href_value = "/#/PerfilJugador/" + /*row*/ ctx[5].id_servidor + "*" + /*row*/ ctx[5].nombre_jugador);
    			add_location(a0, file$d, 41, 16, 1509);
    			add_location(td1, file$d, 41, 12, 1505);
    			attr_dev(i, "class", "material-icons left blue-text");
    			add_location(i, file$d, 42, 62, 1667);
    			attr_dev(a1, "href", a1_href_value = "/#/EditarJugador/" + /*row*/ ctx[5].id_jugador);
    			add_location(a1, file$d, 42, 18, 1623);
    			add_location(td2, file$d, 42, 14, 1619);
    			add_location(tr, file$d, 39, 12, 1429);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    			append_dev(tr, td0);
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			i = element("i");
    			i.textContent = "add";
    			add_location(th0, file$d, 31, 12, 1163);
    			add_location(th1, file$d, 32, 12, 1194);
    			add_location(th2, file$d, 33, 12, 1224);
    			add_location(tr, file$d, 30, 10, 1146);
    			attr_dev(thead, "class", "blue darken-1 white-text");
    			add_location(thead, file$d, 29, 8, 1095);
    			set_style(tbody, "background", "rgba(0,0,0,0.5)");
    			add_location(tbody, file$d, 37, 8, 1331);
    			attr_dev(table, "class", "highlight centered ");
    			add_location(table, file$d, 28, 6, 1051);
    			attr_dev(i, "class", "material-icons left");
    			add_location(i, file$d, 47, 97, 1891);
    			attr_dev(a, "href", "/#/NuevoJugador");
    			attr_dev(a, "class", "btn-floating btn-large waves-effect waves- blue darken-1");
    			add_location(a, file$d, 47, 6, 1800);
    			attr_dev(div, "class", "container");
    			set_style(div, "padding-top", "7%");
    			add_location(div, file$d, 27, 4, 996);
    			set_style(body, "background-image", "url(https://lolstatic-a.akamaihd.net/rso-login-page/2.9.34/assets/riot_desktop_background_2x.jpg)");
    			add_location(body, file$d, 26, 2, 861);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
